/*
    This is the original code that worked with the Make article: http://makezine.com/projects/bees-sensors-monitor-hive-health/
    It's no longer maintained. See newer firmware for the SparkFun Blynk Board
